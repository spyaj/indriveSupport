// Roman Nepali Language Data File - Nepali in English Alphabet
export const RN = {
  nav: {
  ...
  solutions: [
    {
      id: "sol-download-app",
      title: "inDrive App Kasari Download Garnu",
      tags: ["Account", "Download", "App", "Registration", "Getting Started"],
      opening: "inDrive ma jodiera kamauna chahanubhayeko ma dherai khusi lagyo! Yo ekdam sajilo chha.",
